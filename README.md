📚 STACKS
      ...
      >
        <title id="titleId">JMY's GitHub Stats, Rank: A+</title>
        <desc id="descId">Total Stars Earned: 0, Total Commits in 2022 : 0, Total Issues: 0</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 126.52641876884677;
      }
    }
